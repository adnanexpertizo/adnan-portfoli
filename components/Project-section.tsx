        ...
        <div className="flex justify-center mb-10">
          <div className="inline-flex bg-muted rounded-full border border-border p-1">
            <button
              ...
              className={`px-4 py-2 rounded-full cursor-pointer text-sm md:text-[14px] font-medium transition-all ${
                activeTab === "personal"
                    ...
                    <div className="flex gap-2 justify-between mt-auto">
                      ...
                      {project.link === "restricted" ? (
                        <Button
                          size="sm"
                          disabled
                          className="md:w-[150px] w-[110px] rounded-lg text-[12px] bg-gray-200 text-gray-600 h-[30px] md:h-[40px]"
                        >
                          Restricted
                        </Button>
                      ) : (
                        <Button
                          size="sm"
                          className="md:w-[150px] w-[110px] text-[12px] gap-2 h-[30px] md:h-[40px]"
